...
# include sitecustomize if it exists
export PYTHONPATH="/root/LAMoE:${PYTHONPATH}"
...
COMPRESSED_MODEL="/root/fsas/zhanghongyu/LAMoE/models/Qwen/expert_svd_router_avg_la_k45"
